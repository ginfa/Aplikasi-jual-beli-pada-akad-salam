...
<html>
<head>
<title>PT. SALAM INDONESIA - Pemesanan Pangan</title>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <!-- /.nav-second-level -->
                                ...
                                <li><a href="pageUser.php"><font color="40E0D0" style="font-weight: bold;"> Feedback </font></a></li>
          ...
          <div class="panel-ctrls" data-actions-container="" data-action-collapse="{&quot;target&quot;: &quot;.panel-body&quot;}"><span class="button-icon has-bg"><i class="ti ti-angle-down"></i></span></div>
            ...
            <div class="panel-body no-padding">
              ...
              <table class="table table-striped" style="margin-left:0px ">
                     <tr>
                       <tr>
                         <td width="50px">Jenis Pangan</td>
                         <td>
                           <label>
                             <select id="nama_brg" name="nama_brg" onchange="cekHarga2()" style="width: 150px" required="true">
                       ...
                       <tr>
                         ...
                         <td>
                        <label>
                          Rp. <input type="textfield" id="nominalHarga" name="nominalHarga" placeholder="Nominal Harga" readonly="true" required="true"> / kg
                        </label>
                       </td>
                       </tr>
                     <tr>
                     ...
                     <tr>
                       <td width="50">Total Harga</td>
                         <td>
                          <label>
                            Rp. <input type="text" id="totalHarga" name="totalHarga" placeholder="Total Harga" readonly="true" required="true">
                          </label>
                         </td>
                     </tr>
                     <br>
